...
public class StrainingRecipe extends IForgeRegistryEntry.Impl<StrainingRecipe>
{
    ...
    protected IIngredient<FluidStack> outputFluid;
    protected float skillMultiplier; //TODO: Butchering skill should modify curd drops, anywhere from 1-3
    ...
    public StrainingRecipe(IIngredient<FluidStack> inputFluid, ItemStack outputItem, IIngredient<FluidStack> outputFluid, float skillMultiplier)
    {
