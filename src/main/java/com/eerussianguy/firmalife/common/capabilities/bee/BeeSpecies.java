...
public enum BeeSpecies implements StringRepresentable
{
    ...
    KOSCHEVNIKOV(Map.of(BeeAbility.HARDINESS, 2, BeeAbility.PRODUCTION, 1, BeeAbility.NATURE_RESTORATION, 1), 12f, 16f, 200f, 375f, 1, false),
    HIMALAYAN_GIANT(Map.of(BeeAbility.HARDINESS, 3, BeeAbility.MUTANT, 1, BeeAbility.PRODUCTION, 1), 10f, 19f, 150f, 250f, 5, true),
    PHILIPPINE(Map.of(BeeAbility.CALMNESS, 1, BeeAbility.CROP_AFFINITY, 1), 15f, 20f, 350f, 450f, 1, false),
