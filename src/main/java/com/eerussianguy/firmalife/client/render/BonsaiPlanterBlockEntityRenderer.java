...
public class BonsaiPlanterBlockEntityRenderer implements BlockEntityRenderer<LargePlanterBlockEntity>
{
    ...
    public void render(LargePlanterBlockEntity planter, float partialTicks, PoseStack poseStack, MultiBufferSource buffers, int combinedLight, int combinedOverlay)
    {
        ...
        // branches
        RenderUtils.renderTexturedCuboid(poseStack, buffer, branch, combinedLight, combinedOverlay, 7 / 16f, 7 / 16f, 7 / 16f, 9 / 16f, 18 / 16f, 9 / 16f);
        RenderUtils.renderTexturedCuboid(poseStack, buffer, branch, combinedLight, combinedOverlay, 7 / 16f, 12 / 16f, 4 / 16f, 9 / 16f, 14 / 16f, 7 / 16f);
        RenderUtils.renderTexturedCuboid(poseStack, buffer, branch, combinedLight, combinedOverlay, 5 / 16f, 14 / 16f, 8 / 16f, 7 / 16f, 16 / 16f, 12 / 16f);

        // leaves
        RenderUtils.renderTexturedCuboid(poseStack, buffer, leaves, combinedLight, combinedOverlay, 4 / 16f, 12 / 16f, 10 / 16f, 10 / 16f, 19f / 16f, 16 / 16f);
        RenderUtils.renderTexturedCuboid(poseStack, buffer, leaves, combinedLight, combinedOverlay, 3 / 16f, 11 / 16f, 5 / 16f, 11 / 16f, 21 / 16f, 11 / 16f);
        RenderUtils.renderTexturedCuboid(poseStack, buffer, leaves, combinedLight, combinedOverlay, 4 / 16f, 10 / 16f, 1 / 16f, 12 / 16f, 17 / 16f, 7 / 16f);
