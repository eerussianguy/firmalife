...
public class FLClientEvents
{
    ...
    public static void clientSetup(FMLClientSetupEvent event)
    {
        ...
        Stream.of(FLBlocks.CLAY_OVEN_BOTTOM, FLBlocks.CLAY_OVEN_TOP, FLBlocks.CLAY_OVEN_CHIMNEY, FLBlocks.CLAY_OVEN_HOPPER,
            ...
            FLBlocks.RAJYA_METOK_WHEEL, FLBlocks.CHEVRE_WHEEL, FLBlocks.SHOSHA_WHEEL, FLBlocks.FETA_WHEEL, FLBlocks.GOUDA_WHEEL, FLBlocks.BLUE_WHEEL, FLBlocks.SMALL_CHROMITE,
