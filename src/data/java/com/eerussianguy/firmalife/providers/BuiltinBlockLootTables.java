...
public class BuiltinBlockLootTables extends BlockLootSubProvider implements Accessors
{
    ...
    protected void generate()
    {
        ...
        dropSelf(FLBlocks.INSULATED_OVEN_TOP);
        ...
        dropSelf(FLBlocks.CLAY_OVEN_BOTTOM);
        dropSelf(FLBlocks.CLAY_OVEN_TOP);
        dropSelf(FLBlocks.CLAY_OVEN_CHIMNEY);
        dropSelf(FLBlocks.CLAY_OVEN_HOPPER);
        dropSelf(FLBlocks.RUSTIC_BRICKS);
        dropSelf(FLBlocks.RUSTIC_BRICK_DECOR);
        dropSelf(FLBlocks.TILES);
        dropSelf(FLBlocks.TILE_BRICKS);
        dropSelf(FLBlocks.TILE_BRICK_DECOR);
        ...
        dropSelf(FLBlocks.SEALED_BRICK_LADDER);
