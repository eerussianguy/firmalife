...
def generate(rm: ResourceManager):
    ...
    rm.crafting_shaped('crafting/sweeper', ['SR', ' R'], {'S': 'tfc:metal/saw_blade/steel', 'R': '#forge:rods/stainless_steel'}, 'firmalife:sweeper')
    rm.crafting_shaped('crafting/picker', ['SB', 'RR', 'RR'], {'S': '#forge:sheets/stainless_steel', 'R': '#forge:rods/stainless_steel', 'B': 'tfc:brass_mechanisms'}, 'firmalife:picker')
    ...
    rm.crafting_shapeless('crafting/nachos', (not_rotten('firmalife:food/tortilla_chips'), not_rotten('firmalife:food/salsa'), not_rotten('firmalife:food/shredded_cheese'), not_rotten('#firmalife:foods/cooked_meats_and_substitutes')), 'firmalife:food/nachos').with_advancement('firmalife:food/tortilla_chips')
    rm.crafting_shaped('crafting/lasagna', ['XQ', 'YZ', 'XQ'], {'X': not_rotten('firmalife:food/raw_egg_noodles'), 'Y': 'firmalife:food/tomato_sauce', 'Z': '#firmalife:foods/cooked_meats_and_substitutes', 'Q': 'firmalife:plant/oregano'}, 'firmalife:food/raw_lasagna').with_advancement('firmalife:food/raw_egg_noodles')
