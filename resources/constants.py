...
SIMPLE_ITEMS = ('fruit_leaf', 'beeswax', 'pineapple_fiber', 'pineapple_leather', 'pineapple_yarn', 'rennet', 'watering_can', 'treated_lumber', 'cheesecloth', 'blue_mold', 'spoon',
...
SIMPLE_FOODS = ('frothy_coconut', 'white_chocolate_blend', 'dark_chocolate_blend', 'milk_chocolate_blend', 'tofu', 'soy_mixture', 'yak_curd', 'goat_curd', 'milk_curd', 'ricotta', 'mozzarella', 'cheddar', 'chevre', 'rajya_metok', 'gouda', 'feta', 'shosha', 'blue_cheese', 'butter',
...
DEFAULT_LANG = {
    ...
    'firmalife.climate_station.active': 'Providing climate control',
    'firmalife.climate_station.inactive': 'No valid structure found',
    'firmalife.climate_station.structure_greenhouse': '%s Greenhouse: %s blocks',
    'firmalife.climate_station.structure_cellar': 'Cellar: %s blocks',
    'firmalife.climate_station.click_me': 'Right click to update.',
    ...
    **{'firmalife.bee.infection%s' % i: d for i, d in enumerate(PARASITIC_INFECTIONS)},
    ...
    'tfc.recipe.barrel.firmalife.barrel_sealed.food.ricotta': 'Ricotta',
    'tfc.recipe.barrel.firmalife.barrel_sealed.food.mozzarella': 'Mozzarella',
    'tfc.recipe.barrel.firmalife.barrel_sealed.blue_mold': 'Culturing Blue Mold',
    ...
    'tfc.recipe.barrel.firmalife.barrel_sealed.ferment_red_grapes': 'Fermenting Red Grapes',
    'tfc.recipe.barrel.firmalife.barrel_sealed.ferment_white_grapes': 'Fermenting White Grapes',
    ...
    'config.jade.plugin_firmalife.climate_station': 'Climate Station',
