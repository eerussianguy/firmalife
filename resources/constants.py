...
SIMPLE_ITEMS = ('fruit_leaf', 'cinnamon_bark', 'beeswax', 'pineapple_fiber', 'pineapple_leather', 'pineapple_yarn', 'rennet', 'watering_can', 'treated_lumber', 'cheesecloth', 'spoon',
                ...
                'empty_jar_with_stainless_steel_lid', 'tirage_mixture', 'queen_bee', 'filled_beehive_frame', 'beehive_frame', 'sugared_beehive_frame', 'scraped_beehive_frame', 'insulating_beehive_frame', 'wild_honeycomb', 'aromatic_honeycomb')
